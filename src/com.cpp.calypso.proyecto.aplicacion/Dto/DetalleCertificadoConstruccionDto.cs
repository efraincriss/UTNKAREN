...
{
    [AutoMap(typeof(DetalleCertificadoConstruccion))]
    [Serializable]
    public class DetalleCertificadoConstruccionDto : EntityDto
    {
        ...
        [Obligado]
        [DisplayName("Computo")]
        public int DetalleAvanceObraId { get; set; }
        public virtual DetalleAvanceObra DetalleAvanceObra { get; set; }
