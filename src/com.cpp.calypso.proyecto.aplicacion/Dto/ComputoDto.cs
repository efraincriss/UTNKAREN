...
{
    [AutoMap(typeof(Computo))]
    [Serializable]
    public class ComputoDto: EntityDto
    {
        [Obligado]
        [DisplayName("Wbs")]
        ...
        [DisplayName("Refercia_Computo_Presupuesto")]
        public int ref_computo_presupuesto_id { get; set; }

        [DisplayName("Temporal")]
        public bool es_temporal { get; set; } = false;

        public bool cantidadAjustada { get; set; } = false;
        public string tipo { get; set; }

        public string id_rubro_RDO { get; set; }
