...
{
    [AutoMap(typeof(OfertaComercial))]
    [Serializable]
    public class OfertaComercialDto : EntityDto
    {
        ...
        public virtual string nombre_estado_proceso { get; set; }
        public virtual string proyecto_ligados { get; set; }
        public virtual string proyecto_ligados_id { get; set; }
        public virtual string nombre_estado { get; set; }

        public virtual bool tieneTransmital { get; set; }
        public virtual string tieneOrdenProceder { get; set; }
