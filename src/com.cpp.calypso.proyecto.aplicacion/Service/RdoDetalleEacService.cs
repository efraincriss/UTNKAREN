...
{
    public class RdoDetalleEacAsyncBaseCrudAppService : AsyncBaseCrudAppService<RdoDetalleEac, RdoDetalleEacDto, PagedAndFilteredResultRequestDto>, IRdoDetalleEacAsyncBaseCrudAppService
    {
        ...
        public RdoDetalleEacAsyncBaseCrudAppService(
            IBaseRepository<RdoDetalleEac> repository,
        ...
        public List<RdoDetalleEacDto> Listar(int id)
        {
            var query = Repository.GetAll()
                .Where(o => o.vigente)
                .Where(o => o.RdoCabeceraId == id);

            var items = (from r in query
                         select new RdoDetalleEacDto()
                         {
                             Id = r.Id,
        ...
        public decimal CalcularRdoDetallesEAC(int RdoCabeceraId, DateTime fecha_reporte)
        {
            ...
            var detalles = new List<RdoDetalleEac>();
            ...
            foreach (var c in computos)
            {
                ...
                //AC DIARIO= AC_ACTUAL - AC_ANTERIOR
                ...
                decimal costo_budget_version_anterior = rdoAnterior != null ? this.CostoBudgetVersionRDOAnterior(c.Id, fecha_reporte, cabecera.ProyectoId, detallesRDOAnterior) : 0;


                decimal ev_actual_version_anterior = rdoAnterior != null ? this.EvActualVersionRDOAnterior
                    (c.Id, fecha_reporte, cabecera.ProyectoId, detallesRDOAnterior) : 0;
        ...
        public decimal CalcularRdoDetallesEACRDOAnterior(int RdoCabeceraId, DateTime fecha_reporte)
        {
            ...
            {
                decimal cantidad_acumulada_r = Decimal.Round(
                                                this.ObtenerCantidadAcumuladaAnteriorRDO(c.Id, fecha_reporte, cabecera.ProyectoId, detalles)
                                                , 8);
                ...
                decimal ac_diario_r = ac_actual_r - ac_anterior_r;
                // porcentaje_avance_anterio
                decimal porcentaje_avance_anterior_r = 0;
                ...
                if (costo_eac_r > 0)
                {
                    porcentaje_avance_anterior_r = Decimal.Round(
                                    ...
                                    (Decimal.Round(c.cantidad_eac, 2) == 0) ? 1 :
                                     rdoAnterior != null ? this.PorcentajeAvanceAnterior_RDOAnterior(c.Id, fecha_reporte, cabecera.ProyectoId, detallesRDOAnterior) : (Decimal.Round(ac_anterior_r, 8) / Decimal.Round(costo_eac_r, 8))
                                   , 8);//si
                }
                if (c.cantidad_eac == 0)
                {
                ...
                if (costo_eac_r > 0)
                {
                    ...
                    porcentaje_avance_diario_r = Decimal.Round(
                               ...
                               porcentaje_avance_actual_acumularo_r - porcentaje_avance_anterior_r
                                , 8);
                }
                ...
                var detalle = new RdoDetalleEac()
                {
                   ...
                   ,
                    ...
                    cantidad_acumulada = Decimal.Round(cantidad_total_r, 8),
                    ac_actual = Decimal.Round(ac_actual_r, 8),
                    ev_anterior = rdoAnterior != null ? this.EvAnterior_RDOAnterior(c.Id, fecha_reporte, cabecera.ProyectoId, detallesRDOAnterior) :
                        Decimal.Round(Decimal.Round(costo_presupuesto_r, 8)
                                    * Decimal.Round(porcentaje_avance_anterior_r, 8)
                                    , 8),
        ...
        decimal ObtenerCantidadAcumuladaAnteriorRDO(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
        ...
        decimal ACAnterior_RDOAnterior(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
        ...
        decimal EvAnterior_RDOAnterior(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
        ...
        decimal CostoBudgetVersionRDOAnterior(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
        ...
        decimal EvActualVersionRDOAnterior(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
        ...
        decimal PorcentajeAvanceAnterior_RDOAnterior(int computoId, DateTime fecha_reporte, int proyectoId, List<RdoDetalleEac> RdoAnterior)
        {
