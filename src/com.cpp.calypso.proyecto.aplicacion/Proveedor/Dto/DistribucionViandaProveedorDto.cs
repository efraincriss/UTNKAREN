...
namespace com.cpp.calypso.proyecto.aplicacion.Dto
{
    ...
    [Serializable]
    public class DistribucionViandaProveedorDto : EntityDto
    {
        ...
        public virtual string proveedor_identificacion{ get; set; }
        public virtual string proveedor_zona { get; set; }
        ...
        public virtual string anotador_nombre { get; set; }
    }
}
