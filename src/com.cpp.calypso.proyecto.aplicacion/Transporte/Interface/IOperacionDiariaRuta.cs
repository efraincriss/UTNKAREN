...
{
    public interface IOperacionDiariaRutaAsyncBaseCrudAppService : IAsyncBaseCrudAppService<OperacionDiariaRuta, OperacionDiariaRutaDto, PagedAndFilteredResultRequestDto>
    {
