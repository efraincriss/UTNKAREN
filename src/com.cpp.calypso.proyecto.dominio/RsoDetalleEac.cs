...
namespace com.cpp.calypso.proyecto.dominio
{
    ...
    [Serializable]
    public class RsoDetalleEac : Entity
    {
        ...
        [Obligado]
        [DisplayName("Rso Cabecera")]
        public int RsoCabeceraId { get; set; }

        public RsoCabecera RsoCabecera { get; set; }
        ...
        [DisplayName("CostoBudgetVersionAnterior")]
