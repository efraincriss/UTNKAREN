...
{
    [Serializable]
    public class TempOferta : Entity
    {
        ...
        [DisplayName("Días emisión oferta")]
        public int dias_recepcion_os { get; set; }


        public string comentarios_so { get; set; }
        public string status_ejecucion { get; set; }
        public string link_carpeta_compartida { get; set; }
