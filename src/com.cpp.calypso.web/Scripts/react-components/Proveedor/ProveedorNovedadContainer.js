...
import ProveedorNovedadList from './ProveedorNovedadList';
import ProveedorNovedadForm from './ProveedorNovedadForm';
import config from '../Base/Config';

class ProveedorNovedadContainer extends React.Component {
    ...
    onDeleteItem(entity) {
        ...
        let url = '';
        url = `${this.state.urlApiBase}/DeleteProveedorNovedadApi`;
    ...
    render() {
        ...
        return (
            <BlockUi tag="div" blocking={blocking}>
                <div className="row">
                    ...
                    <div className="col">
                        <div className="col nav justify-content-end">
                            <button className="btn btn-outline-primary" onClick={this.onNewItem} > Nueva Novedad  </button>
                        </div>
                    </div>
                </div>
                ...
                <Dialog header="Novedades" visible={this.state.visibleForm} width="680px" modal minY={70} onHide={this.onHide} maximizable>

                    <ProveedorNovedadForm
...
export default ProveedorNovedadContainer;
