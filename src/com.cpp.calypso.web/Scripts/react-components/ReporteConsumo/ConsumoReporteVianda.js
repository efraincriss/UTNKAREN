...
class ConsumoReporte extends React.Component {
  ...
  isValidTwo() {
    ...
    if (this.state.fechaFin != null && this.state.fechaInicio != null && this.state.fechaFin < this.state.fechaInicio) {
  ...
  EnviarFormulario(event) {
    ...
    else 
    {
      ...
      window.location.href = "/Proveedor/ReporteConsumo/ReporteDiario?proveedorId="+this.state.proveedorId+"&fecha="+moment(this.state.fecha).format('MM-DD-YYYY');    
  ...
  EnviarFormulario_two(event) {
    ...
    if (!this.isValidTwo()) {
      ...
      window.location.href = "/Proveedor/ReporteConsumo/ReporteMensual?proveedorIdM="+this.state.proveedorIdM+"&fechaInicio="+moment(this.state.fechaInicio).format('MM-DD-YYYY')+"&fechaFin="+moment(this.state.fechaFin).format('MM-DD-YYYY');
