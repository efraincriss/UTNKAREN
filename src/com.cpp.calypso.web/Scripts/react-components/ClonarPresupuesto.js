...
class ClonePresupuesto extends React.Component{
    constructor(props) {
        super(props)
    ...
    handleSubmit(event){
        ...
        if(this.state.ProyectoId == 0){
            ...
            axios.post("/Proyecto/Wbs/ClonarWBS",{
                ...
                OfertaId: document.getElementById('content-clone-presupuesto').className
            })
            .then((response) => {
    ...
    getProyectos(){
        axios.post("/Proyecto/Oferta/GetProyectosApi/"+document.getElementById('content-clone-presupuesto').className,{})
        .then((response) => {
...
ReactDOM.render(
    <ClonePresupuesto />,
    document.getElementById('content-clone-presupuesto')
  );