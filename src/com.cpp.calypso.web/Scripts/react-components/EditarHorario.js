...
export default class EditarHorario extends React.Component {
    ...
    constructor(props) {
        ...
        this.ConsultaHorario = this.ConsultaHorario.bind(this);
        this.handleValidation = this.handleValidation.bind(this);

    }

    componentDidMount() {
        this.ConsultaHorario(sessionStorage.getItem('id_horario'));
    ...
    ConsultaHorario(id) {
        axios.post("/RRHH/Horario/GetHorarioApi/" + id, {})
            .then((response) => {
                console.log(response)
                this.setState({
                    codigo: response.data.codigo,
                    nombre: response.data.nombre,
                    h_inicio: response.data.h_inicio,
                    h_fin: response.data.h_fin,
    ...
    handleSubmit(event) {
        ...
        if (this.state.formIsValid) {
            ...
            axios.post("/RRHH/Horario/EditApiAsync/", {
                Id: sessionStorage.getItem('id_horario'),
...
ReactDOM.render(
    <EditarHorario />,
    document.getElementById('content-editar-horario')
);