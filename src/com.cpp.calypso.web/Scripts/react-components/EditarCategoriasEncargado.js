...
export default class EditarCategoriasEncargado extends React.Component {
    ...
    componentDidMount() {
        this.GetCatalogos();
        this.GetCategoriasEncargado(sessionStorage.getItem('id_CategoriasEncargado'));
    }
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="form-group">
                                        ...
                                        <select value={this.state.encargado} onChange={this.handleChange} className="form-control" name="encargado" disabled>
    ...
    GetCatalogos() {
        ...
        axios.post("/RRHH/CategoriasEncargado/GetByCodeApiList/", { codigo: codigos })
            .then((response) => {
    ...
    GetCategoriasEncargado(id) {
        axios.post("/RRHH/CategoriasEncargado/GetCategoriaEncargadoApiAsync/" + id, {})
            .then((response) => {
                this.setState({ encargado: response.data });
                this.GetCategoriasDisponibles(this.state.encargado);
                this.GetTargetCategorias(this.state.encargado);
            })
            .catch((error) => {
                console.log(error);
                this.setState({ loading: false });
...
ReactDOM.render(
    <EditarCategoriasEncargado />,
    document.getElementById('content-editar-categorias-encargado')
);