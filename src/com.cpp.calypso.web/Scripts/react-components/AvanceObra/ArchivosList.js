...
class ArchivosList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    ObtenerArchivos = () => {
        ...
        axios
            .post("/Proyecto/AvanceObra/UploadFileList/" + document.getElementById('AvanceId').className, {})
            .then(response => {
    ...
    onDownloaImagen = Id => {
        ...
        return (
            window.location = `/Proyecto/AvanceObra/Descargar/${Id}`
        );
    }
    ...
    EnviarFormulario(event) {
        ...
        if (!this.isValid()) {
            ...
            if (this.state.action == 'create') {
                ...
                formData.append('AvanceObraId', document.getElementById('AvanceId').className);
                ...
                axios
                    .post("/Proyecto/AvanceObra/CreateArchivo",formData ,multipart)
                    .then(response => {
                ...
                axios
                .post("/Proyecto/AvanceObra/EditarArchivo", {
                    Id: this.state.Id,
...
const Container = wrapForm(ArchivosList);
ReactDOM.render(<Container />, document.getElementById("content_archivos_a"));
