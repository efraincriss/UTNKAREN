...
import TreeWbs from "../wbs_components/TreeWbsEAC";
import ComputoForm from "./ComputoForm";
import { Dropdown } from "primereact/components/dropdown/Dropdown";
export default class CrearComputoEAC extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      message: "",
      ...
      tipoAjuste: [
        ...
        { label: "Red Line", value: "RL" },
        { label: "Topografía", value: "TOP" },
      ],
      tipoAjusteString: "",
    };
