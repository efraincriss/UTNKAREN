...
export default class Historicos extends React.Component {
  ...
  Enviar = event => {
    ...
    axios
      .post("/proyecto/ofertacomercial/GetEnviarOferta", {
        Id: this.props.transmittal.OfertaComercialId,
                    ...
                    <div className="row">
                      <div className="col-6">
                        <h6>
                          ...
                          {this.props.transmittal != null
                            ? this.props.transmittal.codigo_transmital
                            : ""}
                        </h6>
                        <h6>
                          <b>Descripción:</b>
                      ...
                      <div className="col-6">
                        <h6>
                          <b>Digido a:</b>{" "}
                          {this.props.transmittal != null
                            ? this.props.transmittal.dirigido_a
                            : ""}
                        </h6>
                        <h6>
                          <b>Con Copia:</b>{" "}
                          {this.props.transmittal != null
                            ? this.props.transmittal.copia_a
                            : ""}
                        </h6>
                        <h6>
                          <b>Versión:</b>{" "}
                          {this.props.transmittal != null
                            ? this.props.transmittal.version
                            : ""}
                        </h6>
                      </div>
                    </div>
