...
export default class ParadasTable extends React.Component {
    constructor(props) {
        super(props)
    }
            ...
            <div>
                <BootstrapTable data={this.props.data} hover={true} pagination={true}>
                    ...
                    <TableHeaderColumn
                        ...
                        thStyle={{ whiteSpace: 'normal', textAlign: 'center' }}
                        filter={{ type: 'TextFilter', delay: 500 }}
                        dataSort={true}>Referencia</TableHeaderColumn>
        ...
        return (
            <div>
                ...
                <button className="btn btn-outline-danger" style={{ marginLeft: '0.3em' }}
                    onClick={() => { if (window.confirm(`Esta acción eliminará la parada con código ${row.Codigo}, ¿Desea continuar?`)) this.props.onDelete(cell) }}
                    data-toggle="tooltip"
                    data-placement="top"
