...
export default class ElementoForm extends React.Component{
    constructor(props){
        super(props);
        this.state = {
            ElementoId: 8,                
            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        <label htmlFor="label">Elemento</label>

                        <select onChange={this.handleChange} className="form-control">
                            {this.getFormSelect(this.props.ListElementos)}
                        </select>
    ...
    handleSubmit(event){
        ...
        axios.post("/proyecto/WbsOferta/CreateWbs",{
            ...
            ElementoId: this.state.ElementoId,
            ActividadId: 0,
            estado: 1,
    ...
    handleChange(event) {
        this.setState({ElementoId: event.target.value});
    }
