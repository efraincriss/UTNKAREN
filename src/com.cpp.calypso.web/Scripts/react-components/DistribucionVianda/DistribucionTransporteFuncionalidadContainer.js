...
class DistribucionTransporteFuncionalidadContainer extends React.Component {
        ...
        return (
            <BlockUi tag="div" blocking={blocking}>
                ...
                <div className="nav justify-content-end">
                    ...
                    <button className="btn btn-outline-primary" onClick={this.handleAprobar} disabled={this.state.isDirty} > Aprobar e Imprimir </button>
                </div>
...
ReactDOM.render(
    <DistribucionTransporteFuncionalidadContainer />,
    document.getElementById('nuc_funcionalidad_body_distribucion_transporte')
);
