...
export default class EditarCargosSector extends React.Component {
    ...
    componentDidMount() {
        this.GetCatalogos();
        this.GetCargosSector(sessionStorage.getItem('id_CargosSector'));
    }
                            ...
                            <div className="row">
                                <div className="col">
                                    <div className="form-group">
                                        ...
                                        <select value={this.state.sector} onChange={this.handleChange} className="form-control" name="sector" disabled>
    ...
    GetCargosSector(id) {
        axios.post("/RRHH/CargosSector/GetCargoSectorApiAsync/" + id, {})
            .then((response) => {
                this.setState({ sector: response.data });
                this.GetCargosDisponibles(this.state.sector);
                this.GetTargetCargos(this.state.sector);
            })
            .catch((error) => {
                console.log(error);
                this.setState({ loading: false });
...
ReactDOM.render(
    <EditarCargosSector />,
    document.getElementById('content-editar-cargos-sector')
);