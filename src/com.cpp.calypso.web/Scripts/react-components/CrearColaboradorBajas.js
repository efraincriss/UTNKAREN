...
import Bajas from './Colaboradores/Bajas/Bajas';
...
export default class CrearColaboradorBajas extends React.Component {
                ...
                <div>
                    ...
                    <ul className="nav nav-tabs" id="detalles_tabs" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link" id="info_general-tab" data-toggle="tab" href="#info_general" role="tab" aria-controls="home" aria-expanded="true">Información General</a>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item">
                            <a className="nav-link active" id="bajas-tab" data-toggle="tab" href="#bajas" role="tab" aria-controls="home" aria-expanded="true">Información de Baja</a>
                        </li>
                    </ul>

                    <div className="tab-content" id="myTabContent">
                        <div className="tab-pane fade show" id="info_general" role="tabpanel" aria-labelledby="info_general-tab" aria-disabled="true">
                        ...
                        <div className="tab-pane fade show active" id="bajas" role="tabpanel" aria-labelledby="bajas-tab">
                            <Bajas
                                regresar={this.Regresar}
                                successMessage={this.successMessage}
                                warnMessage={this.warnMessage}
    ...
    GetCatalogos() {
        ...
        codigos = [
            ...
            'PORCENTAJEDISCAPACIDAD', 'CODIGOSINIESTRO', 'FORMACIONEDUCATIVA', 'FORMACION',
...
ReactDOM.render(
    <CrearColaboradorBajas />,
    document.getElementById('content-crear-bajas')
);