...
const FieldNegrita = (props) => {
    ...
    return (
        <div className="form-group row">
            ...
            <div className={classControl} style={{ marginTop: '1px', marginBottom: '1px' }}>
                {control}
                {error && <div className={classError} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '28px', fontSize: '10px' }}>{error}</div>}
            </div>
        </div>
    );
};

FieldNegrita.propTypes = {
