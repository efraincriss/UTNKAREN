...
//    if (edit) {
//        control = <input name={name} placeholder={placeholder} type="date" value={value} onChange={onChange} className="form-control" {...rest} />;
//    }

//    if (readOnly) {
//        control = <input name={name} type="date" value={value} readOnly className="form-control-plaintext" {...rest} />;
//    }
