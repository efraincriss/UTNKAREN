...
import { Dropdown } from 'primereact-v3.3/dropdown';
...
const Field = (props) => {
    ...
    return (
        <div className="form-group row">
            ...
            <div className={classControl} style={{ marginTop: '0.5px', marginBottom: '0.5px' }}>
                {control}
                {error && <div className={classError} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '25px', fontSize: '9px' }}>{error}</div>}
            </div>
        </div>
    );
};
