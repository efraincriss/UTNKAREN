...
import EditarInformacionGeneral from './Colaboradores/EditarInformacionGeneral';
...
import {
    CODIGO_INCAPACIDAD_NOINCAPACITADO, CODIGO_SINIESTRO_NOINCAPACITADO,
    PARENTESCO_CONYUGE, PARENTESCO_CONVIVIENTE, ESTADO_CIVIL_CASADO, ESTADO_CIVIL_UNION
...
export default class EditarColaborador extends React.Component {
    ...
    constructor(props) {
        ...
        this.ConsultaContactosEmergencia = this.ConsultaContactosEmergencia.bind(this);

        this.validarCedula = this.validarCedula.bind(this);
        this.validarcedulaEC=this.validarcedulaEC.bind(this);
        ...
        this.getFormSelectCodigoSiniestro = this.getFormSelectCodigoSiniestro.bind(this);
        this.getFormSelectFormacionEducativa = this.getFormSelectFormacionEducativa.bind(this);
        ...
        this.getFormSelectCodigoIncapacidad = this.getFormSelectCodigoIncapacidad.bind(this);
        ...
        axios.post("/RRHH/Colaboradores/GetColaboradorApi/", { id: sessionStorage.getItem('id_colaborador') })
            .then((response) => {
               ...
               // this.childServicios.current.ConsultaServicios();
                this.state.colaborador.catalogo_encargado_personal_id > 0 ? this.CargaCategoriaEncargado(this.state.colaborador.catalogo_encargado_personal_id) : '';
    ...
    ConsultaContacto() {
        axios.post("/RRHH/Colaboradores/GetContactoApi/", { id: this.state.colaborador.ContactoId })
            .then((response) => {
    ...
    ConsultaCargaSocial() {
        axios.post("/RRHH/Colaboradores/GetCargasApi/", { id: this.state.id_colaborador })
            .then((response) => {
    ...
    ConsultaContactosEmergencia() {
        axios.post("/RRHH/ContactoEmergencia/GetByColaboradorId/", { id: this.state.id_colaborador })
            .then((response) => {
                ...
                <div>
                    ...
                    <div className="row" >
                        ...
                        <div className="col">
                            ...
                            <div className="row">
                                ...
                                <label htmlFor="text"><b>ID SAP GLOBAL :</b> {this.state.colaborador.empleado_id_sap ? this.state.colaborador.empleado_id_sap : 'No asignado'} </label>
                            </div></div>
                                <div className="col"><div className="form-group">
                                <label htmlFor="text"><b>ID SAP LOCAL :</b> {this.state.colaborador.empleado_id_sap_local ? this.state.colaborador.empleado_id_sap_local : 'No asignado'} </label>
                            </div></div>
                            </div>
                    ...
                    <ul className="nav nav-tabs" id="detalles_tabs" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="info_general-tab" data-toggle="tab" href="#info_general" role="tab" aria-controls="home" aria-expanded="true">Información General</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="contactos-tab" data-toggle="tab" href="#contactos" role="tab" aria-controls="home" aria-expanded="true">Direcciones</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="condiciones_empleo-tab" data-toggle="tab" href="#condiciones_empleo" role="tab" aria-controls="home" aria-expanded="true">Condiciones de Empleo</a>
                        </li>
                        {/*<li className="nav-item">
                            <a className="nav-link" id="servicios-tab" data-toggle="tab" href="#servicios" role="tab" aria-controls="home" aria-expanded="true">Servicios</a>
                        </li>*/}
                        <li className="nav-item">
                            <a className="nav-link" id="cargas_sociales-tab" data-toggle="tab" href="#cargas_sociales" role="tab" aria-controls="home" aria-expanded="true">Familiares</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="nomina-tab" data-toggle="tab" href="#nomina" role="tab" aria-controls="home" aria-expanded="true">Nómina</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="emergencia-tab" data-toggle="tab" href="#emergencia" role="tab" aria-controls="home" aria-expanded="true">Contactos de Emergencia</a>
                        </li>
                    </ul>

                    <div className="tab-content" id="myTabContent">
                        <div className="tab-pane fade show active" id="info_general" role="tabpanel" aria-labelledby="info_general-tab">
                            <EditarInformacionGeneral ref={this.childInfo}
                                ...
                                validarcedulaEC={this.validarcedulaEC}
                                ...
                                getFormSelectTipoDiscapacidad={this.getFormSelectTipoDiscapacidad}
                                getFormSelectCodigoSiniestro={this.getFormSelectCodigoSiniestro}
                                getFormSelectFormacionEducativa={this.getFormSelectFormacionEducativa}
                                ...
                                getFormSelectCodigoIncapacidad={this.getFormSelectCodigoIncapacidad}
                                ...
                                //
                                NombreTipoIdentificacion={this.state.colaborador != null ?
                                    this.state.colaborador.nombre_identificacion : ""}
                                empresa_id={this.state.colaborador != null ?
                                    this.state.colaborador.empresa_id : 0}
                                empresas={this.state.empresas}
                            />
                        </div>
                        <div className="tab-pane fade show" id="contactos" role="tabpanel" aria-labelledby="contactos-tab">
                            <EditarContacto ref={this.childContacto}
                                regresar={this.Regresar}
                                ChangeTab={this.ChangeTab}
                                colaborador={this.state.colaborador}
                        ...
                        <div className="tab-pane fade show" id="condiciones_empleo" role="tabpanel" aria-labelledby="condiciones_empleo-tab">
                            <EditarCondicionesEmpleo ref={this.childEmpleo}
                                regresar={this.Regresar}
                                ...
                                getFormSelectCoberturaDependiente={this.getFormSelectCoberturaDependiente}
                                getFormSelectPlanesBeneficios={this.getFormSelectPlanesBeneficios}
                        ...
                        <div className="tab-pane fade show" id="cargas_sociales" role="tabpanel" aria-labelledby="cargas_sociales-tab">
                            <EditarCargaSocial ref={this.childCargas}
                                regresar={this.Regresar}
                                successMessage={this.successMessage}
                                warnMessage={this.warnMessage}
                                ChangeTab={this.ChangeTab}
                        ...
                        <div className="tab-pane fade show" id="nomina" role="tabpanel" aria-labelledby="nomina-tab">
                            <EditarNomina ref={this.childNomina}
                                regresar={this.Regresar}
                                successMessage={this.successMessage}
                                warnMessage={this.warnMessage}
                                ChangeTab={this.ChangeTab}
                                ...
                                getFormSelectDivisionPersonal={this.getFormSelectDivisionPersonal}
                        ...
                        <div className="tab-pane fade show" id="emergencia" role="tabpanel" aria-labelledby="emergencia-tab">
    ...
    validarEnvio() {
        ...
        if (info == false) {
            ...
            console.log('colll', this.state.colaborador, this.state.colaborador.es_sustituto)
    ...
    ValidarEstadoCivil() {
        var estado = this.state.estados.filter(c => c.Id == Number.parseInt(this.state.colaborador.catalogo_estado_civil_id));
        if (estado.length > 0) {
            if (estado[0].codigo == ESTADO_CIVIL_CASADO || estado[0].codigo == ESTADO_CIVIL_UNION) {
                ...
                if (this.state.cargas != '') {
                    ...
                    this.state.cargas.forEach(e => {
                        var parentesco = this.state.tiposParentesco.filter(c => c.Id == Number.parseInt(e.parentesco_id));
                        if (parentesco[0].codigo == conyuge[0].codigo || parentesco[0].codigo == conviviente[0].codigo) {
                            existe = true;
                        }
                    });
                    if (existe == true) {
                        ...
                        abp.notify.error('Indique el CÓNYUGE O CONVIVIENTE/CONCUBINO en la pestaña de Familiares', 'Error');
                        return false;
                    }
                } else {
                    abp.notify.error('Indique el CÓNYUGE O CONVIVIENTE/CONCUBINO en la pestaña de Familiares', 'Error');
        ...
        if (this.state.colaborador.es_sustituto == true) {
            ...
            if (this.state.cargas != '') {
                ...
                if (sustituto == true) {
                    ...
                    abp.notify.error('Indique el sustituto en la pestaña de Familiares', 'Error');
                    return false;
                }
            } else {
                abp.notify.error('Indique el sustituto en la pestaña de Familiares', 'Error');
    ...
    validarcedulaEC(Identificacion) {
    ...
    GetCatalogos() {
        ...
        codigos = [
            //Informacion General
            'TIPOINDENTIFICACION', 'GENERO', 'ETNIA', 'ESTADOCIVIL', 'TIPODISCAPACIDAD',
            'CODIGOSINIESTRO', 'FORMACIONEDUCATIVA', 'FORMACION',
            'TITULO', 'NACIONALIDADES', 'CODIGOINCAPACIDAD', 'ENCARGADO', 'DESTINOS', 'PROYECTO',
            //Condiciones de Empleo
            'GRUPOPERSONAL', 'AREA',
            ...
            'SITIODETRABAJO', 'SECTOR', 'PARENTESCO',
            //Nomina
            'FUNCION', 'TIPOCONTRATO', 'CLASECONTRATO', 'TIPONOMINA',
            'PERIODONOMINA', 'FORMAPAGO', 'SUBGRUPOCUARTIL', 'BANCO', 'TIPOCUENTA',
            'VIAPAGO', 'DIVISIONPERSONAL', 'SUBDIVISIONPERSONAL'];
    ...
    getFormSelectCodigoIncapacidad() {
        return (
            this.state.tiposIncapacidades.map((item) => {
    ...
    getFormSelectCodigoSiniestro() {
        return (
            this.state.codigoSiniestro.map((item) => {
    ...
    getFormSelectFormacionEducativa() {
        return (
            this.state.formacionAca.map((item) => {
                return (
                    <option key={Math.random()} value={item.Id}>{item.nombre}</option>
                )
            })
    ...
    getFormSelectFormacion() {
        return (
            this.state.tiposFormaciones.map((item) => {
                return (
                    <option key={Math.random()} value={item.Id}>{item.nombre}</option>
                )
            })
    ...
    getFormSelectTitulos() {
        return (
            this.state.tiposTitulos.map((item) => {
                return (
                    <option key={Math.random()} value={item.Id}>{item.nombre}</option>
                )
            })
