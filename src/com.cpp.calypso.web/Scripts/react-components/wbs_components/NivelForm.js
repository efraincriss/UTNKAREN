...
export default class NivelForm extends React.Component{
    constructor(props){
        super(props);
                        ...
                        <div className="tab-pane fade show active" id="ingreso" role="tabpanel" aria-labelledby="ingreso-tab">
                            ...
                            <form onSubmit={this.handleSubmit}>
                                <div className="form-group">
                                    ...
                                    <input type="text" name='nombre' value={this.state.nombre} id="nombre" onChange={this.handleChange} className="form-control"/>
                                </div>
    ...
    handleSubmit(event){
        console.log(this.props.OfertaId)
        event.preventDefault();
        if(this.state.nombre === ""){
            this.props.showWarn("Escribe el nombre del nivel");
        } else {
            axios.post("/proyecto/Wbs/Create",{
