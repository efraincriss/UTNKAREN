...
export default class EditarContacto extends React.Component {
    ...
    constructor(props) {
        ...
        this.GetParr = this.GetParr.bind(this);
    }
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({
            ...
            contacto_id: nextProps.contacto.Id,
            calle_principal: nextProps.contacto.calle_principal == null ? '' : nextProps.contacto.calle_principal,
            numero: nextProps.contacto.numero == null ? '' : nextProps.contacto.numero,
            codigo_postal: nextProps.contacto.codigo_postal == null ? '' : nextProps.contacto.codigo_postal,
            telefono: nextProps.contacto.telefono_convencional == null ? '' : nextProps.contacto.telefono_convencional,
            celular: nextProps.contacto.celular == null ? '' : nextProps.contacto.celular,
            email: nextProps.contacto.correo_electronico == null ? '' : nextProps.contacto.correo_electronico,
            comunidad: nextProps.contacto.ComunidadId == null ? '' : nextProps.contacto.ComunidadId,
            // comunidad_lab: nextProps.contacto.comunidad_comunidad_laboral_id == null ? '' : nextProps.contacto.comunidad_comunidad_laboral_id,
            detalle_comunidad: nextProps.contacto.detalle_comunidad == null ? '' : nextProps.contacto.detalle_comunidad,
            parroquia: nextProps.contacto.ParroquiaId == null ? '' : nextProps.contacto.ParroquiaId,
            // parroquia_lab: nextProps.contacto.parroquia_parroquia_laboral_id == null ? '' : nextProps.contacto.parroquia_parroquia_laboral_id,
            detalle_parroquia: nextProps.contacto.detalle_parroquia == null ? '' : nextProps.contacto.detalle_parroquia,
            pais: nextProps.contacto.PaisId == null ? '' : nextProps.contacto.PaisId,
            // pais_lab: nextProps.contacto.pais_lab == null ? '' : nextProps.contacto.pais_lab,
            provincia: nextProps.contacto.ProvinciaId == null ? '' : nextProps.contacto.ProvinciaId,
            // provincia_lab: nextProps.contacto.provincia_lab == null ? '' : nextProps.contacto.provincia_lab,
            canton: nextProps.contacto.CiudadId == null ? '' : nextProps.contacto.CiudadId,
            // canton_lab: nextProps.contacto.canton_lab == null ? '' : nextProps.contacto.canton_lab,
            amazonia: nextProps.contacto.amazonica == null ? '' : nextProps.contacto.amazonica,
            loading: false
        })
        // this.cargarDatosContacto();
        // console.log(nextProps.contacto.PaisId > 0);
        if (nextProps.contacto.PaisId > 0) {
            this.GetProvinciasR(nextProps.contacto.PaisId)
            this.setState({ loading: true })
        }
        nextProps.contacto.ProvinciaId > 0 ? this.GetCantonR(nextProps.contacto.ProvinciaId) : '';
        nextProps.contacto.CiudadId > 0 ? this.GetParroquiasR(nextProps.contacto.CiudadId) : '';
        if (nextProps.contacto.ParroquiaId > 0) {
            this.GetComunidadR(nextProps.contacto.ParroquiaId)
            this.setState({ loading: false })
        }

        // nextProps.contacto.pais_lab > 0 ? this.GetProvinciasL(nextProps.contacto.pais_lab) : '';
        // nextProps.contacto.provincia_lab > 0 ? this.GetCantonL(nextProps.contacto.provincia_lab) : '';
        // nextProps.contacto.canton_lab > 0 ? this.GetParroquiasL(nextProps.contacto.canton_lab) : '';
        // nextProps.contacto.parroquia_parroquia_laboral_id > 0 ? this.GetComunidadL(nextProps.contacto.parroquia_parroquia_laboral_id) : '';
                    ...
                    <div className="col-xs-12 col-md-12">
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="form-group" /*style={{ marginTop: this.state.visibleComunidadL == true ? '0' : '-6.5%' }}*/>
                                <div className="col">
                                    <button onClick={() => this.handleSubmit()} type="button" className="btn btn-outline-primary fa fa-save" disabled={this.props.disable_button}> Guardar</button>
    ...
    handleSubmit() {
        ...
        if (this.state.formIsValid) {
            ...
            axios.post("/RRHH/Colaboradores/CreateContactoApi/", {
                ColaboradoresId: this.props.colaborador.Id,
                Id: this.props.colaborador.ContactoId,
    ...
    GetComunidadR(Id) {
        ...
        axios.post("/RRHH/Colaboradores/GetComunidadesApi/", { id: Id })
            .then((response) => {
