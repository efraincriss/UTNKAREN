...
export default class EnvioIESS extends React.Component {
    ...
    constructor(props) {
        ...
        this.GenerarArchivoIESS = this.GenerarArchivoIESS.bind(this);
    }
                ...
                <BlockUi tag="div" blocking={this.state.loading}>
                    ...
                    <div className="row">
                        <div className="form-group col">
                            <button type="button" onClick={() => this.GenerarArchivoIESS()} className="btn btn-outline-primary">Guardar</button>
    ...
    GenerarArchivoIESS(){
        ...
        axios.post("/RRHH/ColaboradorBaja/GetArchivoIESSManualApi/", { ids: this.state.filas })
            .then((response) => {
    ...
    GetColaboradoresEnvioSap() {
        this.setState({ loading: true })
        axios.post("/RRHH/ColaboradorBaja/GetBajasArchivoIESS/", {})
            .then((response) => {
                console.log('consulta IESS',response.data)
