...
{
    public abstract class BaseRecursosHumanosSpaController<TEntity, TEntityDto, TGetAllInput> : BaseController
        ...
        where TGetAllInput : PagedAndFilteredResultRequestDto
    {
        ...
        private static readonly ILogger log =
            ServiceLocator.Current.GetInstance<ILoggerFactory>().Create(typeof(BaseRecursosHumanosSpaController<,,>));

        protected BaseRecursosHumanosSpaController(
