...
{
    public abstract class BaseCertificacionSpaController<TEntity, TEntityDto, TGetAllInput> : BaseController
        ...
        where TGetAllInput : PagedAndFilteredResultRequestDto
    {
        ...
        private static readonly ILogger log =
            ServiceLocator.Current.GetInstance<ILoggerFactory>().Create(typeof(BaseCertificacionSpaController<,,>));

        protected BaseCertificacionSpaController(
