...
{
    public class RdoDetalleEacMap : EntityTypeConfiguration<RdoDetalleEac>
    {
        public RdoDetalleEacMap()
        {
            ToTable("rdo_detalles_eac", "SCH_PROYECTOS");
            ...
            HasRequired(p => p.RdoCabecera)
              .WithMany()
              .HasForeignKey(s => s.RdoCabeceraId)
              .WillCascadeOnDelete(false);
